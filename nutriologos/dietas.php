    ...
    <nav class="nav_hero">
        <div class="container nav_container">
            ...
            <div class="links">
                ...
                <a href="dietas.php" class="link link--active">Dietas</a>
        ...
        <div class="formulario" style="border-radius:20px; width:80%; height:auto; background:#fff; display:flex; align-items:left; flex-direction:column;">
            <div style="padding:20px;">
                <div style="display:flex; width:100%; justify-content: space-between;">
                    <h1>Mis Dietas</h1>
                    <a href="formularioCrearDieta.php" class="link">Nuevo Plan Alimenticio<i class='bx bx-add-to-queue icon'></i></a>                
                </div>
            </div>
            <?php
                ...
                if (!$connection) {
                    ...
                    $resultado = ConsultaDietasAsignadas($connection, $_SESSION['ID_Nutriologo']);
                    if (!$resultado) {
                        ...
                        if ($num_rows == 0) {
                            ...
                            echo'<div style="display:flex; justify-content:left; width:100%; padding:25px;"><h3>Aún no has asignado dietas.</h3></div>';
                        } else {
                            //Mostramos todos los registros de la consulta
                            while ($res = mysqli_fetch_array($resultado)) {
                                $pacienteDieta= NombrePacienteDieta($connection, $res["DIETA_Paciente"]);
                                $pacienteNombre = mysqli_fetch_array($pacienteDieta);
                                ...
                                <div style="display:flex; width:100%; justify-content: space-between;">
                                    <h2 style="display:flex; justify-content:left;">Dieta asignada a: '.$pacienteNombre["PAC_Nombre"].' '.$pacienteNombre["PAC_Apellido_paterno"].' '.$pacienteNombre["PAC_Apellido_materno"].'.</h2>
